...
import { listCompanies, deleteCompany } from "@/lib/companies.functions";
...
export const Route = createFileRoute("/_authenticated/empresas/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Gestão das empresas cadastradas na plataforma Vertex Agro." },
      { property: "og:title", content: "Empresas — Vertex Agro" },
      { property: "og:description", content: "Gestão das empresas cadastradas na plataforma Vertex Agro." },
              ...
              <CardContent className="p-5">
                ...
                <div className="mt-4 flex flex-wrap items-center gap-2 text-xs text-muted-foreground">
                  <Badge
                    ...
                    className={c.status === "ativa" ? "bg-success text-success-foreground" : undefined}
                  >
                    {c.status}
                  </Badge>
                  {c.cidade && (
