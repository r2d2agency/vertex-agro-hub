...
function PeoplePage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title="Portal de RH e Equipe"
        description="Gestão centralizada de RH: Cadastro de colaboradores, permissões e acesso administrativo."
        actions={
          companyId ? (
      ...
      <InviteDialog
        ...
        onSaved={(userId) => {
          qc.invalidateQueries({ queryKey: ["people", companyId] });
          if (userId && userId !== "null" && userId !== "undefined") setEditingId(userId);
        }}
